...
export const ChatPanel: React.FC = () => {
  ...
  const send = async (event: React.FormEvent) => {
    ...
    if ((!body.trim() && !attachment) || !conversationId || !user) return;
    setAttachmentError('');
